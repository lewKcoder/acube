//! User service — full CRUD with authentication and input validation.
//!
...
//!     -d '{"username":"charlie","email":"charlie@example.com","display_name":"Charlie"}'
